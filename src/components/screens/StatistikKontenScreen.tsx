                ...
                <Pressable onPress={() => onNavigate("berita-acara-viewer", { newsId: item.id })} className="flex-row items-start gap-3">
                  ...
                  <View className="flex-1">
                    ...
                    <View className="flex-row items-center gap-3 mt-1.5 flex-wrap">
                      <View className="flex-row items-center gap-1"><Heart size={13} color={colors.mutedForeground} /><Text className="text-xs text-muted-foreground">{item.likes_count}</Text></View>
                      <View className="flex-row items-center gap-1"><MessageCircle size={13} color={colors.mutedForeground} /><Text className="text-xs text-muted-foreground">{item.comments_count}</Text></View>
                      <View className="flex-row items-center gap-1"><Clock size={13} color={colors.mutedForeground} /><Text className="text-xs text-muted-foreground">{formatDate(item.activity_date ?? item.created_at)}</Text></View>
                    </View>
                  </View>
